...
@MainActor
@Test func metalModuleResourcesResolvesSurfaceFollowTargetByDestinationID() throws {
    _ = try #require(MTLCreateSystemDefaultDevice())
    let resources = MetalModuleResources()
...
@MainActor
@Test func metalModuleResourcesResolvesNonSurfaceFollowTargetByDestinationID() throws {
    _ = try #require(MTLCreateSystemDefaultDevice())
    let resources = MetalModuleResources()
    let destinations = try decodeDestinationObjects("""
    [
